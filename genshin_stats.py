...
def trivia_stats(): 
    ...
    st.header('Character Trivia (Non-Essential Information for Gameplay)')
    triv_char = st.selectbox('View various trivia about a particular Genshin Impact character:', dc.index)
